 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ga(e,t,n=!1){const i="signIn",r=await Va(e,i,t),o=await qa._fromIdTokenResponse(e,i,r);return n||await e._updateCurrentUser(o.user),o}async function Ja(e,t){return Ga(Ia(e),t)}async function Ya(e,t,n){const i=Ia(e),r=await ja(i,{returnSecureToken:!0,email:t,password:n}),o=await qa._fromIdTokenResponse(i,"signIn",r);return await i._updateCurrentUser(o.user),o}function Qa(e,t,n){return Ja(We(e),Ma.credential(t,n))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
